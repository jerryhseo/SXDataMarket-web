...
public class DeleteDataStructuresResourceCommand extends BaseMVCResourceCommand {
	...
	protected void doServeResource ( ResourceRequest resourceRequest, ResourceResponse resourceResponse )
		...
		if ( strDataStructureIds.isEmpty () ) {
			result.put ( "error", SXLocalizationUtil.translate ( resourceRequest, "there-is-nothing-to-delete" ) );
		...
		long[] longAryDataStructureIds =
					Arrays.stream ( strAryDataStructureIds ).mapToLong ( Long::parseLong ).toArray ();
