package com.sx.datamarket.web.command.action.datatype.editor;
...
@Component(
		property = {
				...
				"mvc.command.name=" + MVCCommand.ACTION_UPDATE_DATATYPE
		},
		service = MVCActionCommand.class
)
public class UpdateDataTypeActionCommand extends BaseMVCActionCommand {
	...
	public void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		...
		String renderCommand = IcecapMVCCommands.RENDER_DATATYPE_EXPLORER; 
