...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=dataset-viewer",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/jsp/dataset-viewer.jsp",
...
public class SXDataSetViewerPortlet extends MVCPortlet {
