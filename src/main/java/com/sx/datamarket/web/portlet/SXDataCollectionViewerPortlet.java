...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=datacollection-viewer",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/jsp/datacollection-viewer.jsp",
		"javax.portlet.name=" + WebPortletKey.SXDataCollectionViewerPortlet,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class SXDataCollectionViewerPortlet extends MVCPortlet {
	...
	public void doView(
		...
		System.out.println("SXDataCollectionViewerPortlet - dataCollectionId: " + dataCollectionId);
