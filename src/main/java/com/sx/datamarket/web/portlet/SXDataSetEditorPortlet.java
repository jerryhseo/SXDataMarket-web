...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=dataset-editor",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/jsp/dataset-editor.jsp",
...
public class SXDataSetEditorPortlet extends MVCPortlet {
	...
	public void doView(
		...
		System.out.println("SXDataSetEditorPortlet: " + dataCollectionId + ", "+dataSetId);
