...
class BaseParameterComponent extends React.Component {
	...
	constructor(props) {
		...
		this.componentId = this.parameter.tagId;
		this.componentName = this.parameter.tagName;
		this.languageId = this.parameter.languageId ?? SXSystem.getLanguageId();
		this.defaultLanguageId = this.parameter.defaultLanguageId ?? SXSystem.getDefaultLanguageId();
		this.availableLanguageIds = this.parameter.availableLanguageIds ?? SXSystem.getAvailableLanguages();
...
export class SXDualListBox extends BaseParameterComponent {
	constructor(props) {
		...
		this.viewType = this.parameter.viewType ?? DualListParameter.ViewTypes.HORIZONTAL;
		this.tagId = this.parameter.tagId;
	...
	getRightOptions() {
		return this.viewType === DualListParameter.ViewTypes.ORDERED
		...
		return (
			<>
				...
				>
					...
					{this.viewType === DualListParameter.ViewTypes.ORDERED && (
