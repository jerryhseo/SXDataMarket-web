...
export const ValidationRule = {
  ...
  SERVER_NAME: '^(?!\\d)[a-zA-Z0-9]+(\\.)[a-zA-Z0-9]+$',
...
export const PortletKeys = {
  COLLECTION_MANAGEMENT: 'SXCollectionManagementPortlet',
...
export const ResourceIds = {
  ...
  DELETE_REFERENCE_FILES: '/ajax/DataStructure/delete-reference-files',
  DELETE_STRUCTURED_DATA: '/ajax/StructuredData/delete-structured-data',
  ...
  DOWNLOAD_FIELD_ATTACHED_FILE: '/ajax/StructuredData/download-field-attached-file',
  EXPORT_DATASTRUCTURE: '/ajax/DataType/export-datastructure',
  LOAD_ASSOCIATED_DATASETS: '/ajax/DataCollection/load-associated-datasets',
  LOAD_ASSOCIATED_DATATYPES: '/ajax/DataSet/load-associated-datatypes',
  ...
  LOAD_STRUCTURED_DATA: '/ajax/StructuredData/load-structured-data',
  OPEN_REFERENCE_FILE: '/ajax/DataStructure/open-reference-file',
  ...
  SAVE_DATATYPE: '/ajax/DataType/save-datatype',
  SAVE_STRUCTUED_DATA: '/ajax/StructuredData/save',
...
export const RequestIDs = {
  ...
  exportDataStructure: 'exportDataStructure',
...
export const Event = {
  ...
  SX_ADD_DATACOLLECTION: 'SX_ADD_DATACOLLECTION',
  SX_ADD_DATASET: 'SX_ADD_DATASET',
  SX_ADD_DATATYPE: 'SX_ADD_DATATYPE',
  SX_ADVANCED_SEARCH_BUTTON_CLICKED: 'SX_ADVANCED_SEARCH_BUTTON_CLICKED',
  SX_ALL_SELECTED: 'SX_ALL_SELECTED',
  SX_APPLICATION_BAR_BTN_CLICKED: 'SX_APPLICATION_BAR_BTN_CLICKED',
  SX_AUTOCOMPLETE_SELECTED: 'SX_AUTOCOMPLETE_SELECTED',
  SX_CHANGE_VIEWMODE: 'SX_CHANGE_VIEWMODE',
  ...
  SX_DATACOLLECTION_CHANGED: 'SX_DATACOLLECTION_CHANGED',
  SX_DATACOLLECTION_SELECTED: 'SX_DATACOLLECTION_SELECTED',
  SX_DATASET_CHANGED: 'SX_DATASET_CHANGED',
  SX_DATASET_SELECTED: 'SX_DATASET_SELECTED',
  SX_DATATYPE_CHANGED: 'SX_DATATYPE_CHANGED',
  SX_DATATYPE_SELECTED: 'SX_DATATYPE_SELECTED',
  SX_DELETE_COMMENT: 'SX_DELETE_COMMENT',
  SX_DELETE_DATACOLLECTION: 'SX_DELETE_DATACOLLECTION',
  SX_DELETE_DATACOLLECTIONS: 'SX_DELETE_DATACOLLECTIONS',
  SX_DELETE_DATASET: 'SX_DELETE_DATASET',
  SX_DELETE_DATASETS: 'SX_DELETE_DATASETS',
  SX_DELETE_DATATYPE: 'SX_DELETE_DATATYPE',
  SX_DELETE_DATATYPES: 'SX_DELETE_DATATYPES',
  SX_DELETE_FILES: 'SX_DELETE_FILES',
  SX_DELETE_PARAMETER: 'SX_DELETE_PARAMETER',
  SX_DELETE_SELECTED: 'SX_DELETE_SELECTED',
  SX_DOWNLOAD_FIELD_ATTACHED_FILE: 'SX_DOWNLOAD_FIELD_ATTACHED_FILE',
  ...
  SX_EXPORT_DATASTRUCTURE: 'SX_EXPORT_DATASTRUCTURE',
  ...
  SX_NAVITEM_SELECTED: 'SX_NAVITEM_SELECTED',
  SX_OPEN_COMMENT_INPUT: 'SX_OPEN_COMMENT_INPUT',
  SX_OPEN_COMMENTS: 'SX_OPEN_COMMENTS',
  SX_OPEN_REFERENCE_FILE: 'SX_OPEN_REFERENCE_FILE',
  ...
  SX_REDIRECT_TO: 'SX_REDIRECT_TO',
  SX_REFRESH: 'SX_REFRESH',
  SX_REFRESH_NAVBAR: 'SX_REFRESH_NAVBAR',
  ...
  SX_SAVE_DATASET: 'SX_SAVE_DATASET',
  SX_SAVE_DATATYPE: 'SX_SAVE_DATATYPE',
