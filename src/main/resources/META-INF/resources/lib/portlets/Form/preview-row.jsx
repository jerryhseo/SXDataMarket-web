...
class SXPreviewRow extends SXBaseParameterComponent {
  ...
  render() {
    ...
    return (
      <>
        <div
          className={className + (this.parameter.position == 'end' ? ' sx-preview-row-end' : ' sx-preview-row')}
          onClick={this.handleClick}
        >
          <div className="autofit-col autofit-col-expand" style={{ marginRight: '10px', width: '100%' }}>
          ...
          <div key={Util.randomKey()} className="autofit-col autofit-col-shrink" style={{ alignSelf: 'center' }}>
            <DropDown
              key={Util.randomKey()}
            ...
            >
              <DropDown.ItemList items={this.actionItems}>
                {(actionItem) => (
                  ...
                  >
                    <Icon spritemap={this.spritemap} symbol={actionItem.symbol} style={{ marginRight: '5px' }} />
                    {actionItem.name}
                  </DropDown.Item>
                )}
              </DropDown.ItemList>
