...
class SXAddress extends SXBaseParameterComponent {
          ...
          <ClayInput.Group small>
            <ClayInput.GroupItem prepend>
              <ClayInput
                ...
                onChange={(e) => {
                  e.stopPropagation();
                  const value = e.target.value.replace(this.state.zipcode + ', ' + this.state.street + ', ', '');
            ...
            <ClayInput.GroupItem shrink append>
              ...
              >
                <span>
                  <Icon symbol="search" spritemap={this.spritemap} />
                </span>
              </Button>
            </ClayInput.GroupItem>
          </ClayInput.Group>
  ...
  renderInlineUI() {
    return (
      <ClayInput.Group small>
        <ClayInput.GroupItem shrink prepend style={{ alignSelf: 'center' }}>
          <ClayButtonWithIcon
        ...
        <ClayInput.GroupItem append style={{ minWidth: '15rem' }}>
          <ClayInput
        ...
        <ClayInput.GroupItem append style={{ minWidth: '6rem' }}>
          <ClayInput
            aria-label={Util.translate('address')}
            value={this.state.address}
            placeholder={Util.translate('detail-address')}
            disabled={this.parameter.getDisabled(this.cellIndex) || !this.parameter.searched[this.cellIndex ?? 0]}
            onChange={(e) => {
              e.stopPropagation();
        ...
        <div style={{ paddingLeft: '10px' }}>
          ...
          {this.parameter.viewType == ParameterConstants.AddressViewTypes.BLOCK && (
            <>
              ...
              <div style={{ display: 'block', marginTop: '10px', marginBottom: '10px' }}>{this.state.street}</div>
              <ClayInput
                value={this.state.address}
                placeholder={Util.translate('detail-address')}
