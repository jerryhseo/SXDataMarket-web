    ...
    return (
      <div style={{ justifyItems: 'center' }}>
        {this.parameter.viewType == ParameterConstants.BooleanViewTypes.CHECKBOX && (
          <ClayCheckbox
            name={tagName}
            labelContent={<span style={{ fontWeight: 'bold' }}>{this.parameter.getTrueLabel()}</span>}
        ...
        {this.parameter.viewType == ParameterConstants.BooleanViewTypes.DROPDOWN && (
          <ClaySelect
            ...
            disabled={this.parameter.getDisabled(this.cellIndex)}
          >
            <ClaySelect.Option label={this.parameter.getTrueLabel()} value="true" />
            <ClaySelect.Option label={this.parameter.getFalseLabel()} value="false" />
          </ClaySelect>
        )}
        {this.parameter.viewType == ParameterConstants.BooleanViewTypes.RADIO && (
          <div className="form-group" style={{ display: 'flex', marginBottom: '5px', paddingLeft: '10px' }}>
