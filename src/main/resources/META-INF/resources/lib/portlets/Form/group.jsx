...
class SXGroup extends SXBaseParameterComponent {
  ...
  renderArrangement() {
    const activeMembers = this.parameter.activeMembers;
    const rows = Util.convertArrayToRows(activeMembers, this.parameter.membersPerRow);

    return (
      <div className={this.className} style={this.style} ref={this.focusRef}>
        ...
        displayTitle={
          <Panel.Title key={Util.randomKey()}>
            ...
            {this.parameter.showDefinition && this.state.expanded && (
              <div className="autofit-row" style={{ paddingLeft: '10px' }}>
    ...
    return (
      ...
      >
        ...
        <table style={{ tableLayout: 'auto', width: '100%' }}>
          <tbody>
            {this.parameter.activeMembers.map((member) => {
