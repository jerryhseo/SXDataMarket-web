...
class SXTypeInfo extends React.Component {
  constructor(props) {
    ...
    this.hasDataStructure = props.hasDataStructure;
          ...
          <Body
            defaultItems={[
              ...
              { fieldName: Util.translate('description'), fieldValue: this.description },
              {
                ...
                fieldValue: this.hasDataStructure ? Util.translate('defined') : Util.translate('undefined')
              },
              {
  ...
  listenerResponse = (event) => {
    ...
    switch (requestId) {
      case RequestIDs.viewDataType: {
        ...
        this.hasDataStructure = hasDataStructure;
            ...
            <div className="autofit-padded-no-gutters-x autofit-row" style={{ alignItems: 'start' }}>
              <div className="autofit-col autofit-col-expand">
                <SXTypeInfo
                  ...
                  hasDataStructure={this.hasDataStructure}
