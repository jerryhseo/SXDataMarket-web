  ...
  renderDataTypeInfo() {
    return (
      <div style={{ marginTop: '1.5rem' }}>
        <SXInstanceInfo title={Util.translate('datatype-info')} infoFields={this.dataTypeInfoFields} fieldsPerRow={4} />
      </div>
    );
  }
      ...
      <div style={{ marginTop: '1rem', marginBottom: '1rem' }}>
        <div className="form-group sx-fieldset">
          ...
          <div className="autofit-float autofit-padded-no-gutters-x autofit-row">
            ...
            <div className="autofit-col">{this.structureDisplayName.render({ spritemap: this.spritemap })}</div>
          ...
          <div className="autofit-col">
            <Button.Group spaced>
              ...
              {(this.dataTypeId || this.state.dataStructureId > 0) && (
                <Button displayType="warning" onClick={() => {}} title={Util.translate('delete-datastructure')}>
                  <Icon symbol="trash" spritemap={this.spritemap} style={{ marginRight: '5px' }} />
              ...
              {this.dataTypeId > 0 && !!this.dataStructure && this.dataStructure.hasMembers() && (
                ...
                >
                  <Icon symbol="export" spritemap={this.spritemap} style={{ marginRight: '5px' }} />
          ...
          <div style={{ textAlign: 'center' }}>
            <Button.Group spaced>
              ...
              {(this.dataTypeId > 0 || this.state.dataStructureId > 0) &&
                this.dataStructure &&
                this.dataStructure.hasMembers() && (
                  <Button displayType="warning" onClick={() => {}} title={Util.translate('delete-data-structure')}>
                    <Icon symbol="trash" spritemap={this.spritemap} style={{ marginRight: '5px' }} />
                    {Util.translate('delete')}
                  </Button>
                )}
