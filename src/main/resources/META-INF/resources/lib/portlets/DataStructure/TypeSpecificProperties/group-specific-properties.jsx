...
class SXGroupTypeOptionForm extends SXBasePropertiesPanelComponent {
  constructor(props) {
    ...
    this.fieldViewType = createParameter({
    ...
    this.fieldMembersPerRow = createParameter({
      namespace: this.namespace,
      formId: this.componentId,
      ...
      properties: {
        ...
        validation: {
          min: {
            value: 0,
            message: Util.getTranslationObject(this.languageId, 'members-per-row-must-be-larger-than-or-equal-to', 0),
            errorClass: ErrorClass.ERROR
          },
          max: {
            value: 10,
            message: Util.getTranslationObject(this.languageId, 'members-per-row-must-be-smaller-than-or-equal-to', 10),
            errorClass: ErrorClass.ERROR
          }
        },
    ...
    this.fieldExpanded = createParameter({
      namespace: this.namespace,
      formId: this.componentId,
  ...
  render() {
    ...
    return (
      <>
        ...
        {this.workingParam.showMembersPerRow && this.fieldMembersPerRow.renderField({ spritemap: this.spritemap })}
