    ...
    switch (dataPacket.paramCode) {
      case 'startYear': {
        ...
        if (endYear && endYear < startYear) {
          dataPacket.parameter.setError(ErrorClass.ERROR, Util.translate('start-year-must-be-smaller-than-end-year'));
          this.dataStructure.setError(ErrorClass.ERROR, Util.translate('start-year-must-be-smaller-than-end-year'));
      ...
      case 'endYear': {
        ...
        if (startYear && endYear < startYear) {
          dataPacket.parameter.setError(ErrorClass.ERROR, Util.translate('end-year-must-be-larger-than-start-year'));
          this.dataStructure.setError(ErrorClass.ERROR, Util.translate('end-year-must-be-larger-than-start-year'));
