...
class SXDSBuilderOptionPropertiesPanel extends SXBasePropertiesPanelComponent {
  constructor(props) {
    ...
    this.fieldToggleGroup = createParameter({
      namespace: this.namespace,
      formId: this.componentId,
    ...
    this.fieldCssWidth = createParameter({
      namespace: this.namespace,
      formId: this.componentId,
