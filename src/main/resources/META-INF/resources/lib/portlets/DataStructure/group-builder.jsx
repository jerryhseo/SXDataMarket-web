...
class SXGroupBuilder extends SXBasePropertiesPanelComponent {
  ...
  copyMember(index) {
    ...
    this.setMemberPropertyFields(copied);
        ...
        >
          ...
          <Body defaultItems={this.groupParam.members}>
            {(member, index) => {
              ...
              return (
                <Row key={member.paramCode} onClick={(e) => this.handleMemberSelected(member)}>
