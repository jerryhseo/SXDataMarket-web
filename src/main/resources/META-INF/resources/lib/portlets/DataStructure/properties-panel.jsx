  ...
  render() {
    ...
    return (
      <>
            ...
            <ClayInput.Group style={{ paddingLeft: '10px' }}>
              ...
              <ClayInput.GroupItem append shrink>
                <Button
                  ...
                  size="sm"
                  disabled={!(this.workingParam.paramCode && this.workingParam.paramVersion)}
                >
        ...
        <div style={{ maxHeight: '700px', overflowY: 'auto', overflowX: 'hidden' }}>{this.renderPanelContent()}</div>
