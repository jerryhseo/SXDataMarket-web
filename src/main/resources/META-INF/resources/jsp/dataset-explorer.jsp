...
<%
	...
	System.out.println("[DataSetExplorer] workbenchId: " + workbenchId);
	System.out.println("[DataSetExplorer] permissions: " + permissions.toString());
%>

<div id="<portlet:namespace />dataSetExplorerRoot"></div>
...
window.SXWorkingPortletInfo = {
		rootElement: "<portlet:namespace />dataSetExplorerRoot",
		portletId: "<%=WebPortletKey.SXDataSetExplorerPortlet%>",
		portletParams:{
