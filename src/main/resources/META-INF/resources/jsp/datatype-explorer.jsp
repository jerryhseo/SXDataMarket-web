...
<%
	...
	System.out.println("[DataTypeExplorer] workbenchId: " + workbenchId);
	System.out.println("[DataTypeExplorer] permissions: " + permissions.toString());
%>

<div id="<portlet:namespace />dataTypeExplorerRoot"></div>
...
window.SXWorkingPortletInfo = {
		rootElement: "<portlet:namespace />dataTypeExplorerRoot",
		portletId: "<%=WebPortletKey.SXDataTypeExplorerPortlet%>",
		portletParams:{
