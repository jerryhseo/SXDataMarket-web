...
<%
	...
	System.out.println("[collection-management.jsp] workbenchNamespace: " + workbenchNamespace);
	System.out.println("[collection-management.jsp] workbenchId: " + workbenchId);
	System.out.println("[collection-management.jsp] viewMode: " + viewMode);
%>
...
<div id="<portlet:namespace />collectionManagementRoot"></div>

<script>
	window.SXWorkingPortletInfo = {
			rootElement: "<portlet:namespace />collectionManagementRoot",
			portletId: "<%=WebPortletKey.SXCollectionManagementPortlet%>",
			portletParams:{
