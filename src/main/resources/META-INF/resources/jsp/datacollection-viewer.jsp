...
<div id="<portlet:namespace />dataCollectionViewerRoot"></div>

<script>
	window.SXWorkingPortletInfo = {
			rootElement: "<portlet:namespace />dataCollectionViewerRoot",
			portletId: "<%=WebPortletKey.SXDataCollectionViewerPortlet%>",
			portletParams:{
