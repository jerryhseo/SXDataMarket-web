...
<%
	...
	String dataCollectionDisplayName = ParamUtil.getString(renderRequest, "dataCollectionDisplayName", "");
	...
	System.out.println("[datacollection-viewer.jsp] workbenchNamespace: " + workbenchNamespace);
	System.out.println("[datacollection-viewer.jsp] workbenchId: " + workbenchId);
%>
...
<div id="<portlet:namespace />dataSetViewerRoot"></div>

<script>
	window.SXWorkingPortletInfo = {
			rootElement: "<portlet:namespace />dataSetViewerRoot",
			portletId: "<%=WebPortletKey.SXDataSetViewerPortlet%>",
			portletParams:{
				...
				params:{
					...
					dataCollectionDisplayName: '<%= dataCollectionDisplayName %>',
